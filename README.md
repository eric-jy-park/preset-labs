...
PresetLabs는 누구나 손쉽게 감성적인 사진 톤을 만들 수 있도록 돕는 웹 기반 프리셋 적용 서비스입니다. 전문 사진가들이 사용하는 Lightroom 프리셋을, 복잡한 편집 지식 없이도 브라우저에서 바로 미리 적용해볼 수 있습니다.

어려운 포토샵도, 무거운 앱 설치도 필요 없습니다.
사진을 업로드하고 마음에 드는 프리셋을 선택하면, 즉시 변화된 톤을 확인할 수 있고, 만족스러운 결과물만 크레딧으로 다운로드할 수 있습니다.

PresetLabs는 “내 사진에 어떤 프리셋이 잘 맞을까?”라는 고민을 줄이고,
누구나 쉽게 감성적인 보정 결과물만 얻을 수 있는 경험을 제공합니다.
<br />
